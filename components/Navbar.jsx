...
const Navbar = () => {
  ...
  return (
    ...
    <nav className='w-full fixed px-5 lg:px-8 xl:px-[-8%] py-8 flex items-center justify-center z-50'>
        <div className='flex items-center gap-8'>
            <ul className='hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white shadow-sm bg-opacity-50 hover:bg-opacity-100 transition-all duration-500 ease-in-out hover:shadow-lg animate-scale'>
                <li>
